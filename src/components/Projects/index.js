...
const Projects = () => {
  const objectData = [  
    {      image: 'https://res.cloudinary.com/db9tsiti3/image/upload/v1730353903/swagger_zjnlgy.png', technology:"NextJS-Express-Swagger", url: 'https://contact-management-nextjs.onrender.com/api/',      description: 'Contact Management - Backend',    },
